...
const FriendRequest = ({ friendRequest }) => {
  return (
    <div className="shadow-sm flex flex-col bg-white rounded-lg w-[220px] pb-3 items-center justify-center">
      ...
      <button className="bg-purple-500 hover:bg-purple-600 text-white rounded-lg p-2 w-[200px] h-[35px] overflow-hidden flex justify-center items-center mb-2 transition duration-200">
        Confirm
      </button>
